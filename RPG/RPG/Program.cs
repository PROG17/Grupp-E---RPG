            ...
            do
            {
                ...
                while (FirstRoom == true)
                {
                    ...
                    else if (Command == "Use")
                    {
                        ...
                        {
                            Hero.Hp_Current -= 50;
                            Console.WriteLine("Health: " + Hero.Hp_Current);
                            Console.WriteLine("");
                        }
                        else
                        {
                             ...
                             Command == "Inspect Door")
                    {
                        ...
                        {
                            Console.WriteLine("");
                            Console.WriteLine("Goes to second room");
                            SecondRoom = true;
                        }
                        ...
                        while (true)
                        {
                                ...
                                Command == "Use Vase" || Command == "Use Ancient Vase")
                            {
                                if (vaseBroken == false)
                                {
                                    ...
                                    Hero.Hp_Current -= arrowDamage;
                                    Console.WriteLine("Your Current HP is " + Hero.Hp_Current +
                                ...
                                || Command == "Fill" && backPack.Contains("Vial") && CauldronIsFull == true)
                            {
                                ...
                                while (UsingAlchTable == true)
                                {
                                    ...
                                    if (Command == "Right")
                                    {
                                        ...
                                        Console.WriteLine("");
                                        backPack.Remove("Vial");
                                        backPack.Add("White Liquid Vial");
                                    ...
                                    else if (Command == "Left")
                                    {
                                        ...
                                        Console.WriteLine("");
                                        backPack.Remove("Vial");
                                        backPack.Add("Green Liquid Vial");
                                        CauldronIsFull = false;
                                        AlchemyTable = false;
                                        UsingAlchTable = false;
                                    }
